...
<html>
	...
	<body>
			<div class="container white"><br>
					...
					<center><div><h5><b><font color="#1b5e20">Agregar una nueva actividad Extra-Escolar</font></b></h5>
						<div><h7><b><font color="#1b5e20">Los campos con * son campos obligatorios</font></b></h7><br><br></center>
						<div class="container">
							<form action="insert_actividad.php" class="pure-form pure-form-stacked" method="post">
							    <fieldset>
							        ...
							        <input id="dias" name="dias" type="text" required>
							        ...
							        <br>
							        <center><button type="submit" class="green darken-4 pure-button pure-button-primary">Guardar Actividad</button><br><br></center>
							    </fieldset>
							</form>
						</div>
					</div>
